module "extract_job" {
  ...
  default_api_start_date = var.default_api_start_date
  default_api_end_date   = var.default_api_end_date
  default_ingest_date    = var.default_ingest_date
  api_extract_script_key = var.api_extract_script_key
  extract_songs_script_key = var.extract_songs_script_key
}
...
module "transform_job" {
  ...
  default_ingest_date = var.default_ingest_date
  transform_json_script_key = var.transform_json_script_key
  transform_songs_script_key = var.transform_songs_script_key
